...
class BrainRingModeratorTimerWidget(TimerAndSoundBaseWidget):  # noqa: WPS214
    ...
    def update_display(self) -> None:
        ...
        if self.timer.is_run_out:
            self.set_font_color(QColor(ColorSchemaEnum.BRAIN_RING_MODERATOR_TIMER_RUN_OUT))
            return
        if self.timer.remaining_time <= 5:
            self.set_font_color(QColor(ColorSchemaEnum.BRAIN_RING_MODERATOR_TIMER_5_SEC_LEFT))
    ...
    def handle_timer_start(self) -> None:
        ...
        self.set_font_color(QColor(ColorSchemaEnum.BRAIN_RING_MODERATOR_TIMER_INITIAL))
        if self.timer.remaining_time <= 5:
            self.set_font_color(QColor(ColorSchemaEnum.BRAIN_RING_MODERATOR_TIMER_5_SEC_LEFT))
