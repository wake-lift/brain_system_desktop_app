...
class BrainRingGameWindow(QMainWindow, Ui_BrainRingGameWindow, WidgetBuilderMixin):  # noqa: WPS214
    ...
    def clear_blocked_players_indicator_layout(self):
        ...
        while self.brain_game_window_blocked_players_indicator_widget_horizontal_layout.count():
            layout_item = self.brain_game_window_blocked_players_indicator_widget_horizontal_layout.takeAt(0)
            if widget := layout_item.widget():
                widget.deleteLater()
