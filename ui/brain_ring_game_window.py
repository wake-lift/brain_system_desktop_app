...
from ui.widgets.base_widgets import ScalableLabel, ScalableSvgWidget
from ui.widgets.icon_widgets import CircleHalfLeftSvgWidget, CircleHalfRightSvgWidget
...
class BrainRingGameWindow(QMainWindow, Ui_BrainRingGameWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.left_signal_widget = self.build_icon_widget(
            widget_cls=CircleHalfLeftSvgWidget,
            background_color=Qt.GlobalColor.white,
            stroke_color=Qt.GlobalColor.white,
            horizontal_stretch=0,
        )
        self.left_signal_widget.hide()
        self.right_signal_widget = self.build_icon_widget(
            widget_cls=CircleHalfRightSvgWidget,
            background_color=Qt.GlobalColor.white,
            stroke_color=Qt.GlobalColor.white,
            horizontal_stretch=0,
        )
    ...
    def build_icon_widget(
        ...
        """Создает автомасштабируемый виджет svg-изображения с указанными параметрами."""
    ...
    def add_widget_to_blocked_players_indicator_layout(self, widget: ScalableSvgWidget):
