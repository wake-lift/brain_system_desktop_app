...
class ColorSchemaEnum(StrLabelEnum):
    ...
    BLACK_PLAYER_STROKE = '#696969', 'Цвет обводки значков для черного игрока'
    ...
    BRAIN_SIGNAL_WIDGET = '#F0FFFF', 'Цвет виджета, сигнализирующего о начале отсчета (брейн-ринг)'
    BRAIN_PLAYER_NAME_LABEL = '#FFFFFF', 'Цвет названия игрока на игровом виджете (брейн-ринг)'
    BRAIN_NOT_FIRST_PLAYER_NAME_LABEL = '#FFFFFF', 'Цвет названия не первого игрока на игровом виджете (брейн-ринг)'
    BRAIN_PLAYER_TIME_LABEL = '#FFFFFF', 'Цвет времени игрока на игровом виджете (брейн-ринг)'
    BRAIN_NOT_FIRST_PLAYER_TIME_LABEL = '#FFFFFF', 'Цвет времени не первого игрока на игровом виджете (брейн-ринг)'
    BRAIN_RING_GAME_TIMER_INITIAL = '#2C97FF', 'Исходный цвет времени на игровом виджете (брейн-ринг)'
    BRAIN_RING_GAME_TIMER_START = '#F0F8FF', 'Цвет времени на игровом виджете (брейн-ринг) после старта таймера'
    ...
    ERUDITE_NOT_FIRST_PLAYER_NAME_LABEL = '#FFFFFF', 'Цвет названия не первого игрока на игровом виджете (эрудитка)'
    ERUDITE_PLAYER_TIME_LABEL = '#FFFFFF', 'Цвет времени игрока на игровом виджете (эрудитка)'
    ERUDITE_NOT_FIRST_PLAYER_TIME_LABEL = '#FFFFFF', 'Цвет времени не первого игрока на игровом виджете (эрудитка)'
